...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets/css/animate.css"> <!-- Corrige el cierre aquí -->
    ...
    <style>
      ...
      .main-nav {
        ...
        box-shadow: 0 4px 10px rgba(0, 0, 0, 0.3);
        border-radius: 0 0 0px 0px; /* Bordes curvos en la parte inferior */
      }
      ...
      /* Añadir un fondo y sombra más fuerte */
      .navbar-nav {
        display: flex;
      ...
      <nav class="main-nav navbar navbar-expand-lg">
        <div class="container d-flex justify-content-between align-items-center container-fluid">
          ...
          <a href="index.html" class="logo">
            <img src="assets/images/logo-t2.png" alt="Logo Intranet Sorteos" style="width: 25%;">
          </a>
          ...
          <ul class="nav">
            ...
            <li><a href="browse.html">Nosotros</a></li>
            <li><a href="details.html">Beneficios</a></li>
            <li><a href="streams.html">Tienda</a></li>
            <li><a href="eventos.html">Eventos</a></li>
            <li><a href="profile.html">Iniciar Sesion<img src="assets/images/profile-header.jpg" alt=""></a></li>
          </ul>
