...
<section id="planes-vigentes" class="py-5" style="background-color: #f3f4f7;">
    <div class="container">
        <h2 class="text-center mb-5" style="font-family: 'Roboto', sans-serif; color: #333; font-weight: bold;">
            Nuestros Planes Premium
        </h2>
        <div class="row g-4 justify-content-center">
            <!-- Plan Mensual -->
            <div class="col-12 col-md-6 col-lg-5">
                <div class="card shadow-lg rounded-4 border-0 p-4 h-100" style="background: linear-gradient(135deg, #6c7ae0, #5d64de); color: white;">
                    <h3 class="card-title text-center mb-4 fs-4">Plan Mensual</h3>
                    <p class="text-center mb-4 fs-6">Accede a todo el contenido exclusivo de manera mensual</p>
                    <h4 class="text-center mb-4 display-6 fw-bold">$15.00</h4>
                    <ul class="text-center fs-6 px-3">
                    ...
                    <div class="text-center mt-4">
                        <button class="btn btn-light text-primary px-4 py-2 rounded-pill fw-semibold" data-bs-toggle="modal" data-bs-target="#modalQR">Suscríbete</button>
                    </div>
                </div>
            </div>
            ...
            <!-- Plan Anual -->
            <div class="col-12 col-md-6 col-lg-5">
                <div class="card shadow-lg rounded-4 border-0 p-4 h-100" style="background: linear-gradient(135deg, #f46b45, #eea849); color: white;">
                    <h3 class="card-title text-center mb-4 fs-4">Plan Anual</h3>
                    <p class="text-center mb-4 fs-6">Obtén acceso ilimitado a todos los beneficios por un año entero</p>
                    <h4 class="text-center mb-4 display-6 fw-bold">$150.00</h4>
                    <ul class="text-center fs-6 px-3">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content rounded-4">
      <div class="modal-header border-0">
        <h5 class="modal-title fw-bold" id="modalQRLabel">Escanea y paga con Yape</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
      </div>
      <div class="modal-body text-center">
      <img src="<?= base_url() ?>public/assets/images/qr.png" alt="Código QR para Yape" class="img-fluid" style="max-width: 300px;">
        <p class="mt-3">Recuerda enviarnos el comprobante vía WhatsApp o correo electrónico.</p>
      </div>
    </div>
  </div>
</div>
...
<!-- Script para cambiar QR según el plan -->
<script>
  document.addEventListener('DOMContentLoaded', () => {
    ...
    modalQR.addEventListener('show.bs.modal', function (event) {
      ...
      // Reemplaza las rutas con las imágenes QR correctas
      const qrSrc = {
        mensual: 'ruta-al-qr-mensual.png',
        anual: 'ruta-al-qr-anual.png'
      };

      qrImage.src = qrSrc[plan];
    });
  });
</script>
